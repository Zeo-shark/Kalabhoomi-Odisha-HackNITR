...
import com.android.github.souravbera.kalabhoomiodisha.Model.Users;
                    ...
                    if(userData.getPhone().equals(phone))
                    {
                        if(userData.getPassword().equals(password))
                        {
                            if(parentDbName.equals("Admins")) {
                                ...
                                Intent HomeIntent = new Intent(LoginActivity.this, com.android.github.souravbera.kalabhoomiodisha.Admin.AdminCategoryActivity.class);
